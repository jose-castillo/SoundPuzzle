...
*/
  ...
  #region SetLocalScale
	...
	public static void SetLocalScale (this Transform transform, float val) {
		vector3.Set (val, val, val);
		transform.localScale = vector3;
	}
  ...
  #region Lerp
	public static void Lerp (this Transform transform, Transform to, float t) {
		...
		transform.LerpLocalScale (to.localScale, t);
	}
  ...
  /**************************************************************************************************/
  /*!
   *    \fn      SmoothStep（２点間の移動をスムーズに行う） の拡張
   *    \date    2015. 1.29(Thu)
   *    \author  Masayoshi.Matsuyama@Donuts
   */
  /**************************************************************************************************/
  ...
  /**************************************************************************************************/
  /*!
   *    \fn      HasChanged（Transform に変更があった場合、通知する）の拡張
   *    \date    2015. 1.29(Thu)
   *    \author  Masayoshi.Matsuyama@Donuts
   */
  /**************************************************************************************************/
  ...
  /**************************************************************************************************/
  /*!
   *    \fn      public static void Reset(this Transform transform)
   *             Transform の初期化
   *    \date    2015. 1.29(Thu)
   *    \author  Masayoshi.Matsuyama@Donuts
   */
